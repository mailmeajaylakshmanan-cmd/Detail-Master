...
class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, errorInfo) {
    ...
    // Auto-reload on Vite dynamic import failure (new deployment)
...
const ManageAssignedOffers = lazy(() => import('./pages/ManageAssignedOffers.jsx'));
  ...
  return (
    <ErrorBoundary>
      ...
      <Route path="/" element={<PrivateRoute><Layout /></PrivateRoute>}>
        ...
        <Route path="master-organization/:id/billing" element={<LazyPage><OrganizationBilling /></LazyPage>} />
