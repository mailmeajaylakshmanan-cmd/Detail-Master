          ...
          {TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-3.5 py-2 rounded-t-lg text-xs sm:text-sm font-bold whitespace-nowrap transition-colors border-b-2 ${isActive
            ...
            {Array.from({ length: Math.min(5, pagination.totalPages || 1) }, (_, i) => {
              ...
              return (
                <button
                  key={p}
                  onClick={() => setPage(p)}
                  className={`w-8 h-8 flex items-center justify-center rounded-lg text-sm font-medium ${page === p
            ...
            {(pagination.totalPages || 1) > 5 && (
              <>
                ...
                <button
                  ...
                  className={`w-8 h-8 flex items-center justify-center rounded-lg text-sm font-medium ${page === pagination.totalPages
